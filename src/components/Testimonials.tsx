      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="text-center mb-12 select-none">
          ...
          <h2 className="text-3xl sm:text-4xl lg:text-5xl font-extrabold text-[#373f50] leading-tight tracking-tight mt-2">
            Apa Kata Mereka <br />
            <span className="text-[#fe696a]">Tentang Layanan Kami</span>
          </h2>
        ...
        <div className="relative flex items-center justify-between gap-4 mt-8 select-none">
          ...
          <button
            onClick={handlePrev}
            className="w-11 h-11 rounded-full bg-white border border-gray-100 flex items-center justify-center text-[#fe696a] hover:bg-[#ffe3e3]/20 shadow-xs cursor-pointer shrink-0 transition-colors z-20"
              ...
              return (
                <div
                  ...
                  className={`bg-white border rounded-[2rem] p-6 sm:p-8 flex flex-col justify-between transition-all duration-500 relative min-h-[300px] ${
                    isMiddle
                      ? "border-[#fe696a]/20 shadow-xl md:scale-105 md:z-10 bg-white"
                ...
                >
                  <div className="space-y-4">
                    ...
                    <Icon
                      icon="lucide:quote"
                      className={`text-[#fe696a]/15 shrink-0 ${isMiddle ? "h-11 w-11" : "h-9 w-9"}`}
                    />
                    {/* Review Text */}
                    ...
                    <div className="flex items-center justify-between gap-3">
                      <div className="flex items-center gap-3 min-w-0">
                        ...
                        <div className="min-w-0">
                          ...
                          <p className="text-[10px] font-bold text-gray-400 truncate uppercase mt-0.5">
                            {item.role}
                          </p>
                          <p className="text-[10px] font-bold text-[#fe696a] truncate uppercase mt-0.5">
                            {item.company}
                          </p>
                        </div>
                      </div>
                      ...
                      <div className="flex gap-0.5 shrink-0">
                        {Array.from({ length: item.stars }).map((_, s) => (
                          <Icon key={s} icon="lucide:star" className="h-3.5 w-3.5 text-[#fe696a] fill-current" />
                        ))}
                      </div>
                    </div>
                  </div>
          ...
          {reviews.map((_, i) => (
            <button
              ...
              className={`h-2 rounded-full transition-all duration-300 ${
                activeIndex === i ? "w-6 bg-[#fe696a]" : "w-2 bg-gray-200 hover:bg-gray-300"
              }`}
        ...
        <div className="bg-white border border-gray-100 rounded-[2rem] p-6 sm:p-8 mt-16 flex justify-center shadow-xs select-none">
          ...
          <div className="w-full max-w-3xl flex items-center justify-around gap-6 sm:gap-12">
            ...
            <div className="flex flex-col items-center text-center">
              <div className="w-9 h-9 rounded-full bg-[#ffe3e3]/50 flex items-center justify-center text-[#fe696a] mb-2 shadow-xs">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mt-1.5">Pelanggan Puas</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mt-1.5">Proyek Selesai</span>
            </div>
            ...
            <div className="flex flex-col items-center text-center">
              ...
              <span className="text-[9px] font-bold text-gray-400 uppercase tracking-wider mt-1.5">Rating Pelanggan</span>
            </div>
          </div>
