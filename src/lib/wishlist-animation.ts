...
export function animateWishlistFly(element: HTMLElement) {
  ...
  heart.innerHTML = `
    <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="#e13b3d" stroke="#e13b3d" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" style="width: 24px; height: 24px; filter: drop-shadow(0 2px 4px rgba(254,105,106,0.3));">
