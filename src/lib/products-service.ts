...
export const DEFAULT_PRODUCTS: UnifiedProduct[] = [
  {
    ...
    published: true,
    metaTitle: "Lanyard Sublimasi Premium Custom - Lanyard Bogor",
    metaDescription: "Cetak lanyard sublimasi premium custom di Bogor. Bahan tissue lembut, cetak full color presisi.",
  ...
  },
  {
    ...
    published: true,
    metaTitle: "Lanyard Anyaman Woven Custom - Lanyard Bogor",
    metaDescription: "Cetak lanyard rajut woven berkualitas tinggi di Bogor. Awet, tulisan rajut tebal dan rapi.",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    published: true,
    metaTitle: "Paket Bundling Lanyard & Holder Premium - Lanyard Bogor",
    metaDescription: "Paket hemat cetak lanyard lengkap dengan holder ID card berkualitas tinggi di Bogor.",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  },
  {
    ...
    published: true,
    metaTitle: "Lanyard Digital Printing Kilat Ekonomis - Lanyard Bogor",
    metaDescription: "Cetak lanyard printing cepat murah berkualitas di Bogor. Selesai tepat waktu untuk event Anda.",
    createdAt: new Date().toISOString(),
    updatedAt: new Date().toISOString(),
  }
];
