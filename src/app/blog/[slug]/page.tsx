            ...
            <div className="bg-[#FFF5F5] rounded-2xl p-6 shadow-xs relative overflow-hidden flex flex-col justify-between min-h-[160px] select-none border border-red-50/50">
              ...
              <div className="pt-4 z-10">
                <a
                  ...
                  target="_blank"
                  className="inline-flex items-center justify-center bg-[#fe696a] hover:bg-[#e04e4f] text-white text-xs font-bold py-2.5 px-4 rounded-xl shadow-xs transition-colors cursor-pointer"
                >
