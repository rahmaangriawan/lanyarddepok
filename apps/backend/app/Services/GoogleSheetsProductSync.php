...
final class GoogleSheetsProductSync
{
    ...
    private const COLUMN_ALIASES = [
        ...
        'name' => ['name', 'nama', 'nama_produk', 'nama_produk_seo_friendly', 'product_name', 'produk'],
        'slug' => ['slug', 'product_slug'],
        'specs' => ['specs', 'spesifikasi', 'specification'],
        'accessories' => ['accessories', 'aksesoris', 'accessory'],
        'basePrice' => ['base_price', 'baseprice', 'harga', 'harga_dasar', 'harga_dasar_rp', 'price'],
        ...
        'description' => ['description', 'deskripsi', 'deskripsi_lengkap', 'deskripsi_lengkap_html', 'long_description'],
